...
// Memoized FAQ item for mobile - prevents re-renders
const MobileFAQItem = memo(function MobileFAQItem({
  faq,
  index,
  isOpen,
  onToggle,
  ...
  return (
    <div
      className={`bg-gray-900 rounded-xl border ${
        isOpen ? "border-cyan-500/50" : "border-gray-800"
      }`}
    >
      <button
      ...
      >
        ...
        <svg
          className={`w-4 h-4 text-cyan-400 flex-shrink-0 ${isOpen ? "rotate-180" : ""}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
...
export default function FAQ() {
  ...
  // Mobile: Ultra-light version - NO blur, NO gradients, NO animations
  if (isMobile) {
    return (
      <section id="faq" className="py-16 bg-gray-950">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400 text-sm mb-3">¿Tienes otra pregunta?</p>
            <a
  ...
  // Desktop: Full version with animations
  return (
