...
function MobileServices() {
  return (
    <section id="servicios" className="py-16 bg-gray-950">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full px-3 py-1.5 mb-4">
            <span className="text-xs text-cyan-400 font-medium">Nuestros Servicios</span>
          </div>
          <h2 className="text-2xl font-bold text-white mb-3">
            Soluciones digitales{" "}
            <span className="text-cyan-400">completas</span>
          </h2>
          <p className="text-sm text-gray-400">
            Todo lo que necesitas para impulsar tu presencia en linea
          </p>
        </div>
          ...
          {services.map((service, index) => (
            <StaggerItem key={index}>
              <TiltCard tiltAmount={8} scale={1.02} className="h-full">
                <div className="group relative glass-card p-10 rounded-2xl hover:border-cyan-500/50 transition-all duration-500 h-full">
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="text-cyan-400">{serviceIcons[index]}</div>
                    </motion.div>
