...
const steps = [
  {
    ...
    title: "Cotizamos",
    description:
      "Te cuento del paquete por WhatsApp y te mando un ejemplo personalizado para tu negocio en menos de 2 minutos. Resolvemos dudas en el chat.",
    icon: (
  ...
  },
  {
    ...
    title: "Diseñamos",
    description:
      "Mandas $1,000 de anticipo y tu material (logo, fotos, textos). Armo la página a la medida en 24 a 36 horas, con tu Google My Business y WhatsApp ya conectados.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    title: "Entregamos",
    description:
      "Sitio en línea, Google optimizado, WhatsApp conectado. Pagas los $2,000 restantes y la página queda tuya. Soporte incluido por 2 semanas para ajustes.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
