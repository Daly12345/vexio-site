...
const steps = [
  ...
  },
  {
    ...
    description:
      "Creamos una propuesta visual de tu sitio web para tu aprobación. Hacemos los ajustes necesarios hasta que estés 100% satisfecho.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    title: "Desarrollo",
    description:
      "Construimos tu sitio web con las últimas tecnologías. Te mantenemos informado del progreso y puedes ver avances en tiempo real.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      "Te presentamos el sitio terminado. Revisamos juntos cada detalle y hacemos los ajustes finales según tus comentarios.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    title: "Lanzamiento",
    description:
      "Publicamos tu sitio web y lo configuramos con tu dominio. Te capacitamos para que puedas hacer actualizaciones básicas si lo deseas.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
