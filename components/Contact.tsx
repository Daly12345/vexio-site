...
const WA_HREF =
  "https://wa.me/5213222440437?text=Hola%2C%20quiero%20cotizar%20una%20p%C3%A1gina%20para%20mi%20negocio";

const PACKAGE_FEATURES = [
  "Página web profesional, responsive y rápida",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Mándanos un mensaje por WhatsApp y te respondemos en menos de 2 minutos con un ejemplo personalizado para tu negocio.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Package summary + primary CTA */}
          <div className="order-2 lg:order-1">
            <div className="relative h-full bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl border-2 border-cyan-500/40 overflow-hidden">
              ...
              <div className="relative p-6 md:p-8">
                <div className="flex items-center gap-2 mb-5">
                  <span className="inline-flex items-center gap-1.5 bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs font-medium px-3 py-1.5 rounded-full uppercase tracking-wider">
                    Paquete Vexio
                  </span>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-300 mt-2">
                    ...
                    Sin mensualidades. Entrega en 48 horas.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  <div className="bg-gray-800/40 rounded-xl p-3 border border-gray-700/50">
                    <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Anticipo</div>
                    <div className="text-lg font-bold text-white">$1,000 MXN</div>
                  </div>
                  <div className="bg-gray-800/40 rounded-xl p-3 border border-gray-700/50">
                    <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Al entregar</div>
                ...
                <MagneticButton strength={0.4} radius={120}>
                  <a
                    ...
                    className="group w-full inline-flex items-center justify-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-6 py-4 rounded-xl font-semibold transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/40 btn-shine"
                  >
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div>
              ...
              <p className="text-gray-400 mb-8">
                WhatsApp es lo más rápido, pero también puedes escribirnos por correo si prefieres.
              </p>
